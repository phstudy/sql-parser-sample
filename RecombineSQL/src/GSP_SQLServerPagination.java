...
public class GSP_SQLServerPagination {

	public static void main(String[] args) {
		System.out.println(getLimitString("SELECT col FROM tbl WHERE col = 1"));
	}

	public static String getLimitString(String querySqlString) {
